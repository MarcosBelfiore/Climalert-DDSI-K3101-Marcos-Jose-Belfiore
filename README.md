...
durante dicha clase (https://github.com/dds-utn/rest-paises/tree/main). Cabe resaltar que se uso el Patron Adapter para desacoplar el consumo de WeatherAPI del modelo de dominio, y JavaMailSender para el envio de Mails.
